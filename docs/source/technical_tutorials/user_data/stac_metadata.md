...
data [(STAC)](https://stacspec.org/en).
...
Metadata Repository
(CMR)](https://www.earthdata.nasa.gov/about/esdis/eosdis/cmr)). These
...
## [STAC Collection-Level Metadata Fields](https://github.com/radiantearth/stac-spec/blob/master/collection-spec/collection-spec.md)
...
- `sci:doi`{sup}`2`: **Required if available**. The DOI of the collection
  ...
  Specification](https://github.com/stac-extensions/scientific/tree/main).

  - For more information and resources about DOIs, see [Open Sourcing
    Code](../../science/oss_documentation/doi_and_licensing.ipynb).
...
- `providers`{sup}`2`: **Required**. The name of the organization(s)
  ...
  - This is a GCMD-controlled field: [Providers CSV file](https://gcmd.earthdata.nasa.gov/kms/concepts/concept_scheme/providers?format=csv).
...
- `keywords`{sup}`2`: **Required**. Keyword(s) that describe the parameters
  ...
  - This is a GCMD-controlled field: [Science Keywords CSV
    file](https://gcmd.earthdata.nasa.gov/kms/concepts/concept_scheme/sciencekeywords/?format=csv).
...
- `summaries`:
  ...
  - `platforms`{sup}`2`: **Required**. Platforms used for data aquisition.
    ...
    - This is a GCMD-controlled field: [Platforms CSV
      file](https://gcmd.earthdata.nasa.gov/kms/concepts/concept_scheme/platforms?format=csv)

  - `instruments`{sup}`3`: **Required**. Instruments used for data
    aquisition.

    - This is a GCMD-controlled field: [Instruments CSV
      file](https://gcmd.earthdata.nasa.gov/kms/concepts/concept_scheme/instruments/?format=csv)
  ...
  - `mission`{sup}`3`: **Required**. The scientific endeavor(s)
    ...
    - This is a GCMD-controlled field: [Projects CSV file](https://gcmd.earthdata.nasa.gov/kms/concepts/concept_scheme/projects/?format=csv)
  ...
  - `processing:level`{sup}`2`: **Required**. The level at which the data in
    ...
    - MAAP recommends using NASA’s Earth Observing System Data and
      ...
      Levels](https://www.earthdata.nasa.gov/learn/earth-observation-data-basics/data-processing-levels).
...
- `item_assets`:
  ...
  - `type`{sup}`2`: **Required**. The media type of the asset.
    ...
    - [Common Media Types in
      STAC](https://github.com/radiantearth/stac-spec/blob/master/best-practices.md#common-media-types-in-stac)
...
## [STAC Item-Level Metadata Fields](https://github.com/radiantearth/stac-spec/blob/master/item-spec/item-spec.md)
...
Below are metadata examples created for MAAP's ["ICESat-2 Boreal v2.1: Gridded Aboveground Biomass Density"](https://stac-browser.maap-project.org/collections/icesat2-boreal-v2.1-agb) dataset.
We have only included a small portion of the metadata - click on the header to see the full example json files.

### [Collection](https://github.com/MAAP-Project/icesat2-boreal-stac/blob/main/examples/agb/collection.json)
...
### [Item](https://github.com/MAAP-Project/icesat2-boreal-stac/blob/main/examples/agb/boreal_agb_2020_202411251732556086_0000004/boreal_agb_2020_202411251732556086_0000004.json)
...
- [UMM-C Schema](https://git.earthdata.nasa.gov/projects/EMFD/repos/unified-metadata-model/browse/collection)
- [Required UMM-C Elements (v1.18.4)](https://git.earthdata.nasa.gov/projects/EMFD/repos/unified-metadata-model/browse/collection/v1.18.4/umm-c-json-schema.json#292)
- [UMM-G Schema](https://git.earthdata.nasa.gov/projects/EMFD/repos/unified-metadata-model/browse/granule)
- [Required UMM-G Elements (v1.6.6)](https://git.earthdata.nasa.gov/projects/EMFD/repos/unified-metadata-model/browse/granule/v1.6.6/umm-g-json-schema.json#139)
- [CEOS EO collection and granule discovery best practices with STAC](https://github.com/ceos-org/stac-collection-and-granule-discovery-best-practices/blob/main/README.md)
